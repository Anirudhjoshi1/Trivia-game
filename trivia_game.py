...
while endGame!= "quit":
    ...
    if(r.status_code !=200):
        ...
        if user_answer == correct_answer:
            print("\nCongratulations you answer it  correctly! The correct answer was " + html.unescape(answer))
            score_correct += 1
        else:
            print("Sorry " +html.unescape(user_answer) + "is incorrect. The correct answer is: " +html.unescape(answer))
            score_incorrect += 1
